...
namespace ZaloDotNetSDK {
    public class APIConfig {
        ...
        public static readonly string USER_AGENT = "zalosdk/4.0 DotNet Open API Java SDK";
        public static readonly string SDK_VERSION = "DotNet 4.0";
        public static readonly string SDK_SOURCE = "DotNetSDK-4.0";
